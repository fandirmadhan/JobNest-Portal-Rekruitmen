...
?>
    ...
    <head>
        ...
        <title>Home - Lowongan Pekerjaan 2025</title>
    ...
    <body>
        <nav class="navbar navbar-default navbar-transparent navbar-fixed-top" color-on-scroll="200">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.php" class="navbar-brand" style="color: #FFFFFF; font-size: 28px;">
                        JobNest
                    </a>
                </div>
        ...
        <div class="section section-header">
            <div class="parallax filter filter-color-black">
                <div class="image" style="background-image: url('img/drft_2.jpg')">
                </div>
                <div class="container">
                    <div class="content">
                        <form method="GET" action="lowongan_list.php">
                            <div class="title-area">
                                <p>Cari Lowongan Pekerjaan yang Kamu Inginkan Diseluruh Indonesia !</p><br/>
                                <div class="row" style="">
                                    <div class="col-md-8">
